...
test_that("save_to_lyx does not accept invalid input",{
  ...
  expect_error(save_to_lyx(currentValue = 1:2, currentName = "a", latexFile = "a.tex"),
               "Names and Values must be of compatible lengths")
  expect_error(save_to_lyx(currentValue = 1:3, currentName = letters[1:3], latexFile = "a.tex", percent = c(T,F)),
